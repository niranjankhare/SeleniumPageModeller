...
public class PagesRecord extends UpdatableRecordImpl<PagesRecord> implements Record4<Integer, String, Integer, String> {

    private static final long serialVersionUID = -527734945;
     ...
     */
    @Override
    public PagesRecord values(Integer value1, String value2, Integer value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PagesRecord(Integer pageid, String pagename, Integer parentid, String pagedescription) {
        super(Pages.PAGES);
